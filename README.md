...
```bash
curl -O https://github.com/3um3le3ee/pfSense-wireguard-peer-export/blob/main/install_wg_export.sh
```
```bash
...
```bash
pkg add https://github.com/3um3le3ee/pfSense-wireguard-peer-export/blob/main/pfSense-pkg-wg-export-0.1.pkg
```
